...
const Blogs = () => {
    return (
        <div className='container'>
            <div>
                <h1 className='font-sans text-2xl font-semibold'>1. What is an access token and refresh token? How do they work and where should we store them on the client-side?</h1> <br />
