...
<div className="mx-auto bg-red-300" data-aos="flip-up">
  ...
  {/* <img src="https://i.ibb.co/dBrpDJJ/bannerg.jpg" alt="" /> */}
...
<div data-aos="zoom-in-up">
  ...
  <img className="min-h-56 rounded min-w-screen" src="https://i.ibb.co/dBrpDJJ/bannerg.jpg" alt="" />
  <div className="hero-overlay bg-opacity-60"></div>
  <div className="hero-content text-center text-neutral-content">
  <div className="flex">
    <input onChange={(e) => setSerch(e.target.value)} type="text" placeholder="Search…" className="input" />
    <button onClick={handleSearch} className="btn btn-square">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
    </button>
  </div>
